...
import {PersonalService } from '../api-service/personal.service'
...
export class PersonalComponent implements OnInit {
  ...
  arrayOfCountries = ['India', 'USA', 'Canada', 'Africa', 'China', 'Japan', 'Australia', 'Germany'];
  ...
  constructor( private _fb : FormBuilder , private router : Router , private http: HttpClient , private personalServer : PersonalService  ){}
  ...
  saveFormToSessionStorage() {
    ...
    this.personalServer.userPersonal(json).subscribe((result)=>{
  ...
  movingtoNextFunction(){
    ...
    this.personalServer.userPersonal(this.personalForm.value).subscribe((result)=>{
      console.log("result=====>" ,result )
    })
